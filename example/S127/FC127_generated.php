	...
	*/
	...
	//********************************* SIMPLE ATTRIBUTES ***********************************************************
			...
			*/
			...
			/**
			* SimpleAttribute horizontalPositionUncertainty
			*
			...
			* @property int value
			*/
			class horizontalPositionUncertainty extends SimpleAttributeType
			{
				public function validate($value)
				{
					return is_real($value);
	...
	//********************************* FEATURE TYPES ***********************************************************
		...
		* 
		* @property fixedDateRange[0..1]  fixedDateRange
		* @property periodicDateRange[0..*]  periodicDateRange
		* @property featureName[0..*]  featureName
		* @property sourceIndication[0..1]  sourceIndication
		* @property textContent[0..1]  textContent
		*
		* @property textAssociation_positions[0..1] TextPlacement
		*
		* @property permissionType_permission[0..*] 
		* @property associatedRxN_theRxN[0..*] 
		* @property additionalInformation_providesInformation[0..*] 
		*/
		abstract class FeatureType extends AbstractFeatureType
		{
			...
			* Generalized feature type which carries all the common attributes
			* 
			* @property fixedDateRange[0..1]  fixedDateRange The complex attribute describes single fixed period, as the date range between its sub-attributes.
			* @property periodicDateRange[0..*]  periodicDateRange The complex attribute describes the active period for a seasonal feature (e.g. a buoy), as the dates between its sub-attributes
			* @property featureName[0..*]  featureName The complex attribute provides the name of an entity, defines the national language of the name, and provides the option to display the name at various system display settings.
			* @property sourceIndication[0..1]  sourceIndication Information about the source document, publication, or reference from which object data or textual material included or referenced in a dataset are derived
			* @property textContent[0..1]  textContent Textual material, or a pointer to a resource providing textual material. May be accompanied by basic information about its source and relationship to the source.
			*
			* @property textAssociation_positions[0..1] TextPlacement
			*
			* @property permissionType_permission[0..*] 
		...
		*
		*
		* @property srvContact_theContactDetails[0..*] 
		*/
		...
		*
		*
		* @property srvControl_controlAuthority[0..1] 
		*/
		...
		*
		* A service feature generally involving one or more reports from the requester, including communications not strictly considered â€œreporting.â€
		* 
		*
		*
		* @property trafficServRept_reptForTrafficServ[0..*] 
		*/
		...
		* 
		* @property categoryOfConcentrationOfShippingHazardArea[0..*]  categoryOfConcentrationOfShippingHazardArea
		...
		*/
		 class ConcentrationOfShippingHazardArea extends FeatureType
		{
			...
			* An area where hazards, caused by concentrations of shipping, may occur. Hazards are risks to shipping, which stem from sources other than shoal water or obstructions.
			* 
			* @property categoryOfConcentrationOfShippingHazardArea[0..*]  categoryOfConcentrationOfShippingHazardArea Classification of shipping hazards due to traffic volume or density.
			* @property status[0..*]  status The condition of an object at a given instant in time.
			*
			*
			*/
			public function __construct()
		...
		* 
		* @property ispsLevel[1..1]  ispsLevel
		*
		*
		*/
		 class IspsCodeSecurityLevel extends OrganisationContactArea
		{
			...
			* The area to which an International Ship and Port Facility Security (ISPS) level applies. The ISPS Code is a comprehensive set of measures to enhance the security of ships and port facilities, developed in response to the perceived threats to ships and port facilities in the wake of the 9/11 attacks in the United States.
			* 
			* @property ispsLevel[1..1]  ispsLevel Classification of ISPS security levels according to the ISPS Code.
			*
			*
			*/
			public function __construct()
		...
		* 
		* @property categoryOfMilitaryPracticeArea[0..*]  categoryOfMilitaryPracticeArea
		* @property nationality[0..1]  nationality
		* @property restriction[0..*]  restriction
		* @property status[0..*]  status
		*
		*
		* @property locationHours_theServiceHours[0..1] 
		*/
		 class MilitaryPracticeArea extends SupervisedArea
		{
			...
			* An area within which naval, military or aerial exercises are carried out. Also called an 'exercise area'.
			* 
			* @property categoryOfMilitaryPracticeArea[0..*]  categoryOfMilitaryPracticeArea Classification of area by military use.
			* @property nationality[0..1]  nationality The nationality of the specific object.
			* @property restriction[0..*]  restriction The official legal statute of each kind of restricted area.
			* @property status[0..*]  status The condition of an object at a given instant in time.
			*
			*
			* @property locationHours_theServiceHours[0..1] 
		...
		* 
		* @property callSign[0..1]  callSign
		* @property categoryOfPilotBoardingPlace[0..1]  categoryOfPilotBoardingPlace
		* @property categoryOfPreference[0..1]  categoryOfPreference
		* @property categoryOfVessel[0..1]  categoryOfVessel
		* @property communicationChannel[0..*]  communicationChannel
		* @property destination[0..1]  destination
		* @property pilotMovement[0..1]  pilotMovement
		* @property pilotVessel[0..1]  pilotVessel
		* @property status[0..*]  status
		*
		* @property pilotageDistrictAssociation_componentOf[0..1] PilotageDistrict
		* @property serviceProvisionArea_serviceProvider[0..*] PilotService
		*
		*/
		 class PilotBoardingPlace extends OrganisationContactArea
		{
			...
			* The meeting place to which the pilot comes out.
			* 
			* @property callSign[0..1]  callSign The designated call-sign of a radio station.
			* @property categoryOfPilotBoardingPlace[0..1]  categoryOfPilotBoardingPlace 
			* @property categoryOfPreference[0..1]  categoryOfPreference The selection of a first choice compared to other options.
			* @property categoryOfVessel[0..1]  categoryOfVessel Classification of vessels by function or use.
			* @property communicationChannel[0..*]  communicationChannel A channel number assigned to a specific radio frequency, frequencies or frequency band.
			* @property destination[0..1]  destination The place or general direction to which a vessel is going or directed.
			* @property pilotMovement[0..1]  pilotMovement Classification of pilot activity by arrival, departure, or change of pilot. It may also describe the place where the pilot's advice begins, ends, or is transferred to a different pilot.
			* @property pilotVessel[0..1]  pilotVessel Description of the pilot vessel. The pilot vessel is a small vessel used by a pilot to go to or from a vessel employing the pilot's services.
			* @property status[0..*]  status The condition of an object at a given instant in time.
			*
			* @property pilotageDistrictAssociation_componentOf[0..1] PilotageDistrict
			* @property serviceProvisionArea_serviceProvider[0..*] PilotService
		...
		* 
		* @property categoryOfPilot[0..*]  categoryOfPilot
		* @property pilotQualification[0..1]  pilotQualification
		* @property pilotRequest[0..1]  pilotRequest
		* @property remotePilot[1..1]  remotePilot
		* @property noticeTime[0..1]  noticeTime
		*
		* @property serviceProvisionArea_serviceArea[0..1] PilotageDistrict
		* @property serviceProvisionArea_serviceArea[0..*] PilotBoardingPlace
		*
		* @property locationHours_theServiceHours[0..1] 
		*/
		 class PilotService extends ReportableServiceArea
		{
			...
			* The service provided by a person who directs the movements of a vessel through pilot waters, usually a person who has demonstrated extensive knowledge of channels, aids to navigation, dangers to navigation, etc., in a particular area and is licensed for that area.
			* 
			* @property categoryOfPilot[0..*]  categoryOfPilot Classification of pilots and pilot services by type of waterway where piloting services are provided.
			* @property pilotQualification[0..1]  pilotQualification Classification of pilots and pilot services by type of license qualification or type of organization providing services.
			* @property pilotRequest[0..1]  pilotRequest Description of the pilot request procedure.
			* @property remotePilot[1..1]  remotePilot Whether remote pilot services are available.
			* @property noticeTime[0..1]  noticeTime Span of time, prior to the time the service is needed, for preparations to be made to fulfil the requirement. 
			*
			* @property serviceProvisionArea_serviceArea[0..1] PilotageDistrict
			* @property serviceProvisionArea_serviceArea[0..*] PilotBoardingPlace
			*
		...
		* @property communicationChannel[0..*]  communicationChannel
		*
		* @property pilotageDistrictAssociation_consistsOf[0..*] PilotBoardingPlace
		* @property serviceProvisionArea_serviceProvider[0..*] PilotService
		*
		*/
		...
		* 
		* @property restriction[1..*]  restriction
		* @property status[0..*]  status
		*
		*
		*/
		 class PiracyRiskArea extends ReportableServiceArea
		{
			...
			* An area where there is a raised risk of piracy or armed robbery.
			* 
			* @property restriction[1..*]  restriction The official legal statute of each kind of restricted area.
			* @property status[0..*]  status The condition of an object at a given instant in time.
			*
			*
			*/
		...
		* @property status[0..*]  status
		*
		* @property trafficControlServiceAggregation_componentOf[0..1] VesselTrafficServiceArea
		*
		*/
		...
		* @property callSign[0..1]  callSign
		* @property communicationChannel[0..*]  communicationChannel
		* @property categoryOfCargo[0..*]  categoryOfCargo
		* @property categoryOfVessel[0..1]  categoryOfVessel
		* @property orientation[0..2]  orientation
		* @property status[0..*]  status
		* @property trafficFlow[1..1]  trafficFlow
		*
		* @property trafficControlServiceAggregation_componentOf[0..1] VesselTrafficServiceArea
		*
		*/
		 class RadioCallingInPoint extends FeatureType
		{
			...
			* @property callSign[0..1]  callSign The designated call-sign of a radio station.
			* @property communicationChannel[0..*]  communicationChannel A channel number assigned to a specific radio frequency, frequencies or frequency band.
			* @property categoryOfCargo[0..*]  categoryOfCargo Classification of the different types of cargo that a ship may be carrying
			* @property categoryOfVessel[0..1]  categoryOfVessel Classification of vessels by function or use.
			* @property orientation[0..2]  orientation The angular distance measured from true north to the major axis of the feature.
			* @property status[0..*]  status The condition of an object at a given instant in time.
			* @property trafficFlow[1..1]  trafficFlow 
			*
			* @property trafficControlServiceAggregation_componentOf[0..1] VesselTrafficServiceArea
			...
			*/
			public function __construct()
			{
				...
				$this->addAttribute('categoryOfVessel', 'categoryOfVessel', 0, 1);
				$this->addAttribute('orientation', 'orientation', 0, 2);
				$this->addAttribute('status', 'status', 0, MAX_OCCUR);
		...
		* 
		* @property categoryOfRestrictedArea[0..*]  categoryOfRestrictedArea
		* @property restriction[1..*]  restriction
		* @property status[0..*]  status
		*
		*
		*/
		 class RestrictedAreaNavigational extends SupervisedArea
		{
			...
			* A specified area of land or water designated by an appropriate authority within which access or navigation is restricted in accordance with certain specified conditions.
				A navigational restricted area is an area where the restrictions have a direct impact on the navigation of a vessel in the area.
			* 
			* @property categoryOfRestrictedArea[0..*]  categoryOfRestrictedArea The official legal status of each kind of restricted area defines the kind of restriction(s), e.g., the restriction for a 'game preserve' may be 'entering prohibited', the restriction for an 'anchoring prohibition area' is 'anchoring prohibited'.
			* @property restriction[1..*]  restriction The official legal statute of each kind of restricted area.
			* @property status[0..*]  status The condition of an object at a given instant in time.
			*
			*
		...
		* 
		* @property categoryOfRouteingMeasure[1..1]  categoryOfRouteingMeasure
		* @property categoryOfTrafficSeparationScheme[0..1]  categoryOfTrafficSeparationScheme
		* @property categoryOfNavigationLine[0..1]  categoryOfNavigationLine
		*
		*
		*/
		 class RouteingMeasure extends FeatureType
		{
			...
			* An area or line designating the limits or central line of a routeing measure (or part of a routeing measure). Routeing measures include traffic separation schemes, deep-water routes, two-way routes, archipelagic sea lanes, and fairway systems.
			* 
			* @property categoryOfRouteingMeasure[1..1]  categoryOfRouteingMeasure Classification of routeing measures by type.
			* @property categoryOfTrafficSeparationScheme[0..1]  categoryOfTrafficSeparationScheme International classification of traffic separation scheme
			* @property categoryOfNavigationLine[0..1]  categoryOfNavigationLine Classification of route guidance given to vessels
			*
			*
			*/
			public function __construct()
		...
		* 
		* @property categoryOfSignalStationWarning[1..*]  categoryOfSignalStationWarning
		* @property communicationChannel[0..*]  communicationChannel
		* @property status[0..*]  status
		*
		* @property trafficControlServiceAggregation_componentOf[0..1] VesselTrafficServiceArea
		...
		*/
		 class SignalStationWarning extends FeatureType
		{
			...
			* A warning signal station is a place on shore from which warning signals are made to ships at sea.
			* 
			* @property categoryOfSignalStationWarning[1..*]  categoryOfSignalStationWarning Classification of station based on the warning service provided
			* @property communicationChannel[0..*]  communicationChannel A channel number assigned to a specific radio frequency, frequencies or frequency band.
			* @property status[0..*]  status The condition of an object at a given instant in time.
			*
			* @property trafficControlServiceAggregation_componentOf[0..1] VesselTrafficServiceArea
		...
		* 
		* @property categoryOfSignalStationTraffic[1..*]  categoryOfSignalStationTraffic
		* @property communicationChannel[0..*]  communicationChannel
		* @property status[0..*]  status
		*
		* @property trafficControlServiceAggregation_componentOf[0..1] VesselTrafficServiceArea
		...
		*/
		 class SignalStationTraffic extends OrganisationContactArea
		{
			...
			* A traffic signal station is a place on shore from which signals are made to regulate the movement of traffic.
			* 
			* @property categoryOfSignalStationTraffic[1..*]  categoryOfSignalStationTraffic Classification of station based on the traffic service provided
			* @property communicationChannel[0..*]  communicationChannel A channel number assigned to a specific radio frequency, frequencies or frequency band.
			* @property status[0..*]  status The condition of an object at a given instant in time.
			*
			* @property trafficControlServiceAggregation_componentOf[0..1] VesselTrafficServiceArea
		...
		* 
		* @property underkeelAllowance[0..1]  underkeelAllowance
		* @property waterLevelTrend[0..1]  waterLevelTrend
		*
		*
		*/
		 class UnderkeelClearanceAllowanceArea extends FeatureType
		{
			...
			* An area for which an authority has stated underkeel allowance requirements.
			* 
			* @property underkeelAllowance[0..1]  underkeelAllowance A fixed figure, or a figure derived by calculation, which is added to draught in order to maintain the minimum underkeel clearance taking into account the vessel's static and dynamic characteristics, sea state and weather forecast, the reliability of the chart and variance from predicted height of tide or water level.
			* @property waterLevelTrend[0..1]  waterLevelTrend The tendency of water level to change in a particular direction.
			*
			*
			*/
			public function __construct()
		...
		* 
		* @property dynamicResource[1..1]  dynamicResource
		*
		*
		*/
		 class UnderkeelClearanceManagementArea extends ReportableServiceArea
		{
			...
			* An area for which an authority permits use of dynamic underkeel clearance information or provides dynamic information related to underkeel clearances.
			* 
			* @property dynamicResource[1..1]  dynamicResource Whether a vessel must use a shore-based or other resource to obtain up-to-date information.
			*
			*
			*/
			public function __construct()
		...
		* 
		* @property categoryOfVesselTrafficService[1..1]  categoryOfVesselTrafficService
		* @property serviceAccessProcedure[0..1]  serviceAccessProcedure
		* @property requirementsForMaintenanceOfListeningWatch[1..1]  requirementsForMaintenanceOfListeningWatch
		*
		* @property trafficControlServiceAggregation_consistsOf[0..*] RadioCallingInPoint
		* @property trafficControlServiceAggregation_consistsOf[0..*] RadarRange
		* @property trafficControlServiceAggregation_consistsOf[0..*] SignalStationWarning
		* @property trafficControlServiceAggregation_consistsOf[0..*] SignalStationTraffic
		*
		*/
		 class VesselTrafficServiceArea extends ReportableServiceArea
		{
			...
			* The area of any service implemented by a relevant authority primarily designed to improve safety and efficiency of traffic flow and the protection of the environment. It may range from simple information messages, to extensive organisation of the traffic involving national or regional schemes.
			* 
			* @property categoryOfVesselTrafficService[1..1]  categoryOfVesselTrafficService Classification of vessel traffic services based on the nature of the control or services provided.
			* @property serviceAccessProcedure[0..1]  serviceAccessProcedure A description of the procedure to access the marine service.
			* @property requirementsForMaintenanceOfListeningWatch[1..1]  requirementsForMaintenanceOfListeningWatch 
			*
			* @property trafficControlServiceAggregation_consistsOf[0..*] RadioCallingInPoint
			* @property trafficControlServiceAggregation_consistsOf[0..*] RadarRange
		...
		* 
		* @property dynamicResource[1..1]  dynamicResource
		* @property siltationRate[0..1]  siltationRate
		* @property status[0..*]  status
		*
		*
		*/
		 class WaterwayArea extends SupervisedArea
		{
			...
			* 
			* @property dynamicResource[1..1]  dynamicResource Whether a vessel must use a shore-based or other resource to obtain up-to-date information.
			* @property siltationRate[0..1]  siltationRate A description of the rate at which the depth in an area decreases.
			* @property status[0..*]  status The condition of an object at a given instant in time.
			*
			*
			*/
		...
		*/
		...
		/**
		* FeatureType QualityOfNonTemporalVariation
		*
		* Abstract type for meta-feature which can describe temporal variation.
		* 
		* @property categoryOfTemporalVariation[1..1]  categoryOfTemporalVariation
		*
		*
		*/
		abstract class QualityOfNonTemporalVariation extends DataQuality
		{
			...
			* Abstract type for meta-feature which can describe temporal variation.
			* 
			* @property categoryOfTemporalVariation[1..1]  categoryOfTemporalVariation An assessment of the likelihood of change over time.
			*
			*
			*/
			public function __construct()
		...
		* 
		* @property maximumDisplayScale[1..1]  maximumDisplayScale
		* @property minimumDisplayScale[1..1]  minimumDisplayScale
		*
		*
		*/
		 class DataCoverage extends AbstractFeatureType
		{
			...
			* A geographical area that describes the coverage and extent of spatial types.
			* 
			* @property maximumDisplayScale[1..1]  maximumDisplayScale The largest intended viewing scale for the data.
			* @property minimumDisplayScale[1..1]  minimumDisplayScale The smallest intended viewing scale for the data.
			*
			*
			*/
			public function __construct()
		...
		* 
		* @property directionUncertainty[0..1]  directionUncertainty
		* @property horizontalDistanceUncertainty[0..1]  horizontalDistanceUncertainty
		* @property horizontalPositionUncertainty[0..1]  horizontalPositionUncertainty
		* @property sourceIndication[0..1]  sourceIndication
		* @property surveyDateRange[0..1]  surveyDateRange
		*
		*
		*/
		 class QualityOfNonBathymetricData extends QualityOfTemporalVariation
		{
			...
			* An area within which a uniform assessment of the quality of the non-bathymetric data exists
			* 
			* @property directionUncertainty[0..1]  directionUncertainty The best estimate of the accuracy of a bearing.
			* @property horizontalDistanceUncertainty[0..1]  horizontalDistanceUncertainty The best estimate of the horizontal accuracy of horizontal clearances and distances.
			* @property horizontalPositionUncertainty[0..1]  horizontalPositionUncertainty The best estimate of the accuracy of a position. The expected input is the maximum of the two-dimensional error. The error is assumed to be positive and negative. The plus/minus character shall not be encoded.
			* @property sourceIndication[0..1]  sourceIndication Information about the source document, publication, or reference from which object data or textual material included or referenced in a dataset are derived
			* @property surveyDateRange[0..1]  surveyDateRange The complex attribute describes the period of the hydrographic survey, as the time between its sub-attributes.
			*
			*
			*/
			public function __construct()
		...
		* 
		* @property flipBearing[0..1]  flipBearing
		* @property scaleMinimum[0..1]  scaleMinimum
		* @property textJustification[1..1]  textJustification
		* @property text[0..1]  text
		* @property textType[0..1]  textType
		*
		* @property textAssociation_identifies[1..1] FeatureType
		*
		*/
		 class TextPlacement extends AbstractFeatureType
		{
			...
			* The Text Placement feature is used in association with the Feature Name attribute or a light description to optimise text positioning in ECDIS.
			* 
			* @property flipBearing[0..1]  flipBearing The bearing at which text is re-located to the opposite side of a feature when screen display is oriented away from true north.
			* @property scaleMinimum[0..1]  scaleMinimum The minimum scale at which the object may be used, e.g., for ECDIS presentation.
			* @property textJustification[1..1]  textJustification The anchor point of a text string
			* @property text[0..1]  text A non-formatted digital text string
			* @property textType[0..1]  textType The attribute from which a text string is derived.
			*
			* @property textAssociation_identifies[1..1] FeatureType
			*
			*/
	...
	//********************************* INFORMATION TYPES ***********************************************************
		...
		* @property periodicDateRange[0..*]  periodicDateRange
		* @property featureName[0..*]  featureName
		* @property sourceIndication[0..*]  sourceIndication
		*
		*
		* @property additionalInformation_providesInformation[0..*] 
		*/
		abstract class InformationType extends AbstractInformationType
		{
			...
			* @property periodicDateRange[0..*]  periodicDateRange The complex attribute describes the active period for a seasonal feature (e.g. a buoy), as the dates between its sub-attributes
			* @property featureName[0..*]  featureName The complex attribute provides the name of an entity, defines the national language of the name, and provides the option to display the name at various system display settings.
			* @property sourceIndication[0..*]  sourceIndication Information about the source document, publication, or reference from which object data or textual material included or referenced in a dataset are derived
			*
			*
			* @property additionalInformation_providesInformation[0..*] 
			*/
		...
		* 
		* @property categoryOfAuthority[0..1]  categoryOfAuthority
		* @property textContent[0..*]  textContent
		* @property graphic[0..*]  graphic
		* @property rxnCode[0..*]  rxnCode
		*
		*
		* @property inclusionType_isApplicableTo[0..*] 
		* @property relatedOrganisation_theOrganisation[0..*] 
		*/
		abstract class AbstractRxN extends InformationType
		{
			...
			* 
			* @property categoryOfAuthority[0..1]  categoryOfAuthority The type of person, government agency or organisation granted powers of managing or controlling access to and/or activity in an area
			* @property textContent[0..*]  textContent Textual material, or a pointer to a resource providing textual material. May be accompanied by basic information about its source and relationship to the source.
			* @property graphic[0..*]  graphic Pictorial information such as a photograph, sketch, or other graphic, optionally accompanied by descriptive information about the graphic and the location relative to its subject from which it was made.
			* @property rxnCode[0..*]  rxnCode A summary of the impact of the most common types of regulation, restriction, recommendation and nautical information on a vessel.
			*
			*
			* @property inclusionType_isApplicableTo[0..*] 
			* @property relatedOrganisation_theOrganisation[0..*] 
		...
		* 
		* @property ballast[0..1]  ballast
		* @property categoryOfCargo[0..*]  categoryOfCargo
		* @property categoryOfDangerousOrHazardousCargo[0..*]  categoryOfDangerousOrHazardousCargo
		* @property categoryOfVessel[0..1]  categoryOfVessel
		* @property categoryOfVesselRegistry[0..1]  categoryOfVesselRegistry
		* @property logicalConnectives[0..1]  logicalConnectives
		* @property thicknessOfIceCapability[0..1]  thicknessOfIceCapability
		* @property vesselPerformance[0..1]  vesselPerformance
		* @property information[0..*]  information
		* @property vesselsMeasurements[0..*]  vesselsMeasurements
		*
		*
		* @property inclusionType_theApplicableRxN[0..*] 
		* @property reportReqmt_theShipReport[0..*] 
		* @property permissionType_vslLocation[0..*] 
		*/
		 class Applicability extends InformationType
		{
			...
			* Describes the relationship between vessel characteristics and: (i) the applicability of an associated information object or feature to the vessel; or, (ii) the use of a facility, place, or service by the vessel; or, (iii) passage of the vessel through an area.
			* 
			* @property ballast[0..1]  ballast Whether the vessel is in ballast
			* @property categoryOfCargo[0..*]  categoryOfCargo Classification of the different types of cargo that a ship may be carrying
			* @property categoryOfDangerousOrHazardousCargo[0..*]  categoryOfDangerousOrHazardousCargo Classification of dangerous goods or hazardous materials based on the International Maritime Dangerous Goods Code (IMDG Code)
			* @property categoryOfVessel[0..1]  categoryOfVessel Classification of vessels by function or use.
			* @property categoryOfVesselRegistry[0..1]  categoryOfVesselRegistry The locality of vessel registration or enrolment relative to the nationality of a port, territorial sea, administrative area, exclusive zone or other location.
			* @property logicalConnectives[0..1]  logicalConnectives Expresses whether all the constraints described by its co-attributes must be satisfied, or only one such constraint need be satisfied.
			* @property thicknessOfIceCapability[0..1]  thicknessOfIceCapability The thickness of ice that the ship can safely transit
			* @property vesselPerformance[0..1]  vesselPerformance A description of the required handling characteristics of a vessel including hull design, main and auxilliary machinery, cargo handling equipment, navigation equipment and manoeuvring behaviour.
			* @property information[0..*]  information The complex attribute provides additional textual information that cannot be provided using other allowable attributes for the feature, and defines the language of the text string.
			* @property vesselsMeasurements[0..*]  vesselsMeasurements Terms and definitions specifically related to vessels
			*
			*
			* @property inclusionType_theApplicableRxN[0..*] 
			* @property reportReqmt_theShipReport[0..*] 
		...
		* 
		* @property categoryOfAuthority[1..1]  categoryOfAuthority
		* @property textContent[0..1]  textContent
		*
		*
		* @property authorityContact_theContactDetails[0..*] 
		* @property reptAuthority_theShipReport[0..*] 
		* @property relatedOrganisation_theInformation[0..*] 
		* @property authorityHours_theServiceHours[0..*] 
		*/
		 class Authority extends InformationType
		{
			...
			* A person or organisation having political or administrative power and control.
			* 
			* @property categoryOfAuthority[1..1]  categoryOfAuthority The type of person, government agency or organisation granted powers of managing or controlling access to and/or activity in an area
			* @property textContent[0..1]  textContent Textual material, or a pointer to a resource providing textual material. May be accompanied by basic information about its source and relationship to the source.
			*
			*
			* @property authorityContact_theContactDetails[0..*] 
		...
		* 
		* @property callName[0..1]  callName
		* @property callSign[0..1]  callSign
		* @property categoryOfCommPref[0..1]  categoryOfCommPref
		* @property communicationChannel[0..*]  communicationChannel
		* @property contactAddress[0..*]  contactAddress
		* @property contactInstructions[0..1]  contactInstructions
		* @property frequencyPair[0..*]  frequencyPair
		* @property information[0..*]  information
		* @property mMSICode[0..1]  mMSICode
		* @property onlineResource[0..*]  onlineResource
		* @property telecommunications[0..*]  telecommunications
		*
		*
		* @property authorityContact_theAuthority[0..*] 
		*/
		 class ContactDetails extends InformationType
		{
			...
			* information on how to reach a person or organisation by postal, internet, telephone, telex and radio systems
			* 
			* @property callName[0..1]  callName The designated call name of a station, e.g. radio station, radar station, pilot.
			* @property callSign[0..1]  callSign The designated call-sign of a radio station.
			* @property categoryOfCommPref[0..1]  categoryOfCommPref Classification of frequencies, VHF channels, telephone numbers, or other means of communication based on preference.
			* @property communicationChannel[0..*]  communicationChannel A channel number assigned to a specific radio frequency, frequencies or frequency band.
			* @property contactAddress[0..*]  contactAddress Direction or superscription of a letter, package, etc., specifying the name of the place to which it is directed, and optionally a contact person or organisation who should receive it. (Oxford English Dictionary, 2nd Ed., adapted).
			* @property contactInstructions[0..1]  contactInstructions Instructions provided on how to contact a particular person, organisation or service.
			* @property frequencyPair[0..*]  frequencyPair A pair of frequencies for transmitting and receiving radio signals. The shore station transmits and receives on the frequencies indicated.
			* @property information[0..*]  information The complex attribute provides additional textual information that cannot be provided using other allowable attributes for the feature, and defines the language of the text string.
			* @property mMSICode[0..1]  mMSICode The Maritime Mobile Service Identity (MMSI) Code is formed of a series of nine digits which are transmitted over the radio path in order to uniquely identify ship stations, ship earth stations, coast stations, coast earth stations, and group calls. These identities are formed in such a way that the identity or part thereof can be used by telephone and telex subscribers connected to the general telecommunications network principally to call ships automatically.
			* @property onlineResource[0..*]  onlineResource Information about online sources from which a resource or data can be obtained.
			* @property telecommunications[0..*]  telecommunications A means or channel of communicating at a distance by electrical or electromagnetic means such as telegraphy, telephony, or broadcasting.
			*
			*
			* @property authorityContact_theAuthority[0..*] 
			*/
		...
		*
		*
		* @property additionalInformation_informationProvidedFor[0..*] 
		*/
		...
		* 
		* @property fixedDate[0..*]  fixedDate
		* @property variableDate[0..*]  variableDate
		* @property information[0..*]  information
		*
		*
		*/
		 class NonStandardWorkingDay extends InformationType
		{
			...
			* Days when many services are not available. Often days of festivity or recreation when normal working hours are limited, esp. a national or religious festival, etc.
			* 
			* @property fixedDate[0..*]  fixedDate The date of an event.
			* @property variableDate[0..*]  variableDate A day which is not fixed in the Gregorian calendar.
			* @property information[0..*]  information The complex attribute provides additional textual information that cannot be provided using other allowable attributes for the feature, and defines the language of the text string.
			*
			*
			*/
			public function __construct()
			{
				...
				//AttributeBindings
				$this->addAttribute('fixedDate', 'fixedDate', 0, MAX_OCCUR);
				$this->addAttribute('variableDate', 'variableDate', 0, MAX_OCCUR);
				$this->addAttribute('information', 'information', 0, MAX_OCCUR);
		...
		* 
		* @property scheduleByDayOfWeek[1..*]  scheduleByDayOfWeek
		* @property information[0..*]  information
		*
		*
		* @property exceptionalWorkday_partialWorkingDay[0..*] 
		* @property authorityHours_theAuthority_srvHrs[0..*] 
		*/
		 class ServiceHours extends InformationType
		{
			...
			* The time when a service is available and known exceptions.
			* 
			* @property scheduleByDayOfWeek[1..*]  scheduleByDayOfWeek The nature and timings of a daily schedule by days of the week.
			* @property information[0..*]  information The complex attribute provides additional textual information that cannot be provided using other allowable attributes for the feature, and defines the language of the text string.
			*
			*
			* @property exceptionalWorkday_partialWorkingDay[0..*] 
		...
		* 
		* @property categoryOfShipReport[1..*]  categoryOfShipReport
		* @property imoFormatForReporting[1..1]  imoFormatForReporting
		* @property noticeTime[1..*]  noticeTime
		* @property textContent[0..1]  textContent
		*
		*
		* @property reportReqmt_mustBeFiledBy[0..*] 
		* @property reptAuthority_reportTo[0..*] 
		*/
		 class ShipReport extends InformationType
		{
			...
			* Describes how a ship should report to a maritime authority, including when to report, what to report and whether the format conforms to the IMO standard.
			* 
			* @property categoryOfShipReport[1..*]  categoryOfShipReport Classification of ship reports based on IMO standard report formats.
			* @property imoFormatForReporting[1..1]  imoFormatForReporting Whether a report must be in an IMO standard format
			* @property noticeTime[1..*]  noticeTime Span of time, prior to the time the service is needed, for preparations to be made to fulfil the requirement. 
			* @property textContent[0..1]  textContent Textual material, or a pointer to a resource providing textual material. May be accompanied by basic information about its source and relationship to the source.
			*
			*
			* @property reportReqmt_mustBeFiledBy[0..*] 
		...
		* 
		* 
		* @property categoryOfTemporalVariation[0..1]  categoryOfTemporalVariation
		* @property qualityOfHorizontalMeasurement[0..1]  qualityOfHorizontalMeasurement
		* @property horizontalPositionUncertainty[0..1]  horizontalPositionUncertainty
		*
		*
		*/
		 class SpatialQuality extends AbstractInformationType
		{
			...
			* 
			* 
			* @property categoryOfTemporalVariation[0..1]  categoryOfTemporalVariation An assessment of the likelihood of change over time.
			* @property qualityOfHorizontalMeasurement[0..1]  qualityOfHorizontalMeasurement The degree of reliability attributed to a position
			* @property horizontalPositionUncertainty[0..1]  horizontalPositionUncertainty The best estimate of the accuracy of a position. The expected input is the maximum of the two-dimensional error. The error is assumed to be positive and negative. The plus/minus character shall not be encoded.
			*
			*
			*/
