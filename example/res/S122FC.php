	...
	*/
	...
	//********************************* FEATURE TYPES ***********************************************************
		...
		* @property protectedAreaAuthority_responsibleAuthority[0..*] Authority |Defined in MarineProtectedArea
		* @property fixedDateRange[0..1] fixedDateRange |Defined in FeatureType
		* @property periodicDateRange[0..*] periodicDateRange |Defined in FeatureType
		* @property featureName[0..*] featureName |Defined in FeatureType
		* @property sourceIndication[0..1] sourceIndication |Defined in FeatureType
		...
		* @property additionalInformation_providesInformation[0..*] NauticalInformation |Defined in FeatureType
			*/
			public function __construct()
			{
				...
				//InformationBindings
				$this->addAttribute('protectedAreaAuthority_responsibleAuthority', 'Authority', 0, MAX_OCCUR);
		...
		* @property srvControl_controlAuthority[0..1] Authority |Defined in VesselTrafficServiceArea
		* @property trafficServRept_reptForTrafficServ[0..*] ShipReport |Defined in VesselTrafficServiceArea
		* @property fixedDateRange[0..1] fixedDateRange |Defined in FeatureType
		* @property periodicDateRange[0..*] periodicDateRange |Defined in FeatureType
		* @property featureName[0..*] featureName |Defined in FeatureType
		* @property sourceIndication[0..1] sourceIndication |Defined in FeatureType
